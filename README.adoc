...
ifdef::env-github[]
== Quick start
For a quick look at the essence of ESPHome and Home Assistant configuration, refer to xref:doc/quick_start.adoc[Quick start]
endif::[]

== How it works
For detailed discussion on how `tag` and `anchor` communicate to each other and also to Home Assistant, refer to xref:doc/how-it-works.adoc[How it works]
